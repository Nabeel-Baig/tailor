<?php include('inc/header.php'); ?>
      <div class="banner">
         <img src="assets/images/banner-faq.jpg" alt="banner" class="img-fluid" />
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-12 animatedParent">
                  <div class="panel-group animated fadeInUp" id="accordion" role="tablist" aria-multiselectable="true">
